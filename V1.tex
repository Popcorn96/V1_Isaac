...
\begin{figure} [h!]\caption{$c_p(T)$ Graphit}
\begin{center}
\includegraphics[scale=0.5]{cp(T)Graphit.png} \end{center}
\end{figure} 

\begin{figure} [h!]\caption{$c_p(T)$ Kupfer}
\begin{center}
\includegraphics[scale=0.5]{cp(T)Kupfer.png} \end{center}
\end{figure} 
  

\begin{figure} [h!]\caption{$c_p(T)$ Zink}
\begin{center}
\includegraphics[scale=0.5]{cp(T)Zink.png} \end{center}
\end{figure} 
...
\begin{center}
\begin{table} [h] \caption{Linearer Plot}
\begin{tabular} {r | r|  r }
&m&n\\
\hline
...
\subsection{Berechnung von $\Delta c_{p}(T)$}
...
%aktualisierte Werte in dieser Tabelle
...
Graphit &5,31	&2071	&138&	138$\cdot10^2$\\
        ...
        &15,1	&40,0	&133\\
\hline						
Cu&18,6&	443	&11,0&	820\\
&20,6	&432&	8,63	\\
&21,8	&425	&7,08	\\
&22,6&	420&	6,00\\	
\hline			
Zn&18,6&	402&	10,1&	751\\
&20,6&	396&	7,91	\\
&21,8&	392	&6,53\\
&22,6	&389&	5,56	\\
\end{tabular}
